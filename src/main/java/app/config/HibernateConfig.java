...
public class HibernateConfig {
    ...
    private static EntityManagerFactory createEMF(boolean forTest, String databaseName) {
        try {
            ...
            if (forTest) {
                ...
                props = setDevProperties(props, databaseName);
            }
    ...
    private static Properties setDeployedProperties(Properties props, String databaseName) {
    ...
    private static Properties setDevProperties(Properties props, String databaseName) {
